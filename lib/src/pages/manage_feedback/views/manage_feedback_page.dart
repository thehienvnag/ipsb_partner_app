...
Widget _buildFeedbacks(BuildContext context, List<CouponInUse> listFeedBack,
    ManageFeedbackController controller) {
  final screenSize = MediaQuery.of(context).size;
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Text(feedback.feedbackContent.toString(),
              ...
              Obx(() {
                return (controller.indexViewMore.value
                            .compareTo(index.toString()) ==
                        0)
                    ? Column(
                        children: [
                          Row(
