                ...
                children: [
                  Row(
                    children: [
                      CircleAvatar(
                          radius: 25,
                          backgroundImage: NetworkImage(feedback.visitor!.imageUrl.toString())
                      ),
                      SizedBox(width: 10,),
                      Column(
                ...
                Row(
                  ...
                  children: [
                    Container(
                        ...
                        Card(child: Image.network(feedback.feedbackImage.toString())) : Image.network('https://pngimg.com/uploads/mouth_smile/mouth_smile_PNG42.png')
                    ),
                    Container(
